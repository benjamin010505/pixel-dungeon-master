...
package com.postmodern.postmoderndungeon.desktop;
	...
	public static void main (String[] args) {
		...
		Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
			...
			public void uncaughtException(Thread thread, Throwable throwable) {
				...
				exceptionMsg = exceptionMsg.replace("com.postmodern.postmoderndungeon.", "");
		...
		if (SharedLibraryLoader.isWindows) {
			if (System.getProperties().getProperty("os.name").equals("Windows XP")) {
				basePath = "Application Data/.postmodern/Postmodern Dungeon/";
			} else {
				basePath = "AppData/Roaming/.postmodern/Postmodern Dungeon/";
			}
		} else if (SharedLibraryLoader.isMac) {
			basePath = "Library/Application Support/Postmodern Dungeon/";
		} else if (SharedLibraryLoader.isLinux) {
			basePath = ".postmodern/postmodern-dungeon/";
		}
